        ...
        <header className="h-20 border-b border-white/5 backdrop-blur-3xl bg-black/40 sticky top-0 z-40 px-6 md:px-12 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-8">
             ...
             <div className="flex items-center space-x-4">
                <button className="p-3 bg-white/5 border border-white/10 rounded-xl text-white/40 hover:text-white transition-all relative">
                   <Bell size={18} />
                   <span className="absolute top-2 right-2 w-2 h-2 bg-red-500 rounded-full border-2 border-[#050505]" />
                </button>
                <div className="h-10 w-10 bg-gradient-to-br from-brand-blue to-purple-500 rounded-xl flex items-center justify-center p-0.5 shadow-lg shadow-brand-blue/20 cursor-pointer hover:scale-105 transition-all">
